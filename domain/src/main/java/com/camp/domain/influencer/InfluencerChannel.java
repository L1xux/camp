...
public record InfluencerChannel(Platform platform, ChannelIdentifier identifier, FollowerCount followerCount) {
    ...
    public static InfluencerChannel of(Platform platform, String identifier, long followerCount) {
        return new InfluencerChannel(platform, ChannelIdentifier.of(identifier), FollowerCount.of(followerCount));
    }
